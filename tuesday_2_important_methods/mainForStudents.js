...
//Проверка:
console.log("users === copyUser => false", user === copyUser);
...
//Проверка:
console.log("user === deepCopyUser => true", user[1] === deepCopyUser[1]);
...
//Проверка:
console.log("copyStudents[1] === students[1] => true", copyStudents[1] === students[1]);
console.log("copyStudents[1].name === students[1].name => true", copyStudents[1].name === students[1].name);
// console.log(код проверки написать самостоятельно) - что должно быть в консоли?
// console.log(код проверки написать самостоятельно) - что должно быть в консоли?
// console.log(код проверки написать самостоятельно) - что должно быть в консоли?
...
console.log("concat", newDeepCopyStudents);
...
let trueStudents = students.map(s => s.isStudent);
